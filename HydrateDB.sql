insert into TestSuites(Name, Brand, Version, UploadDate) values('DODO XXXX - Test suite', 'Chevron', '11.02', GETDATE());
insert into TestSuites(Name, Brand, Version, UploadDate) values('DODO XXXX - Test suite2', 'CONCORD', '11.02', GETDATE());
